  ...
  <body>
    ...
    <%
      ...
      String actualizacion = "UPDATE pelicula SET "
                           + "TitPel='" + request.getParameter("titulo")
                           + "', GenPel='" + request.getParameter("genero")
                           + "', DesPel='" + request.getParameter("descripcion")
                           + "', ProPel=" + Integer.valueOf(request.getParameter("codSoc"))
                           + " WHERE CodPel='" + request.getParameter("codigo") + "'";
    ...
    <div class="container" style="padding: 5%;">
        ...
        <div class="panel panel-info noBorder">
            <div class="panel-heading text-center noBorder" style="background-image: linear-gradient(to bottom,#f08080 0,#f0d1ae 100%);">
                <h2 style="color: firebrick;">Película modificada</h2>
