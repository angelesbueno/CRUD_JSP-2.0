...
<html>
  <head>
    ...
    <%
      ...
      s.execute ("DELETE FROM Prestamo WHERE CodPre=" + request.getParameter("codigo"));
    %>	
        ...
        <div class="container" style="padding: 5%;">
            ...
            <div class="panel panel-info noBorder">
                <div class="panel-heading text-center noBorder" style="background-image: linear-gradient(to bottom,#f08080 0,#f0d1ae 100%);">
                    <h2 style="color: firebrick;">Préstamo dado de baja</h2>
                    <a href="inicio.jsp" class="btn btn-default">Volver al listado de préstamos</a>
                </div>
            </div>
        </div>
  </body>
